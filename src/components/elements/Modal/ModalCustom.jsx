                            ...
                            <FlexStart classname="flex-col col-span-4">
                                ...
                                <FlexCenter classname="w-full pt-3 pb-7 border-b border-b-gray-50">
                                    <FlexCenter classname="border p-2 border-gray-100 rounded-full" gap="gap-3">
                                        <Button hover={false} color='' shadow='' padding='' btn="" classname="bg-gray-50 h-10 w-10 flex justify-center items-center"><LuMinus size="18px" /></Button>
                                        <TextCustom type="body_md_400">5</TextCustom>
                                        <Button hover={false} color='' shadow='' padding='' btn="" classname="bg-gray-50 h-10 w-10 flex justify-center items-center"><LuPlus size="18px" /></Button>
                                    </FlexCenter>
                                    <Button classname="w-full text-white" category="add_to_cart">
                                        Add to Cart
                                    </Button>
                                    <Button hover={true} color='' shadow='' padding='' btn="" classname="bg-[rgba(0,178,7,0.2)] text-green-success-dark h-11 w-20 flex justify-center items-center"><LuHeart size="18px" /></Button>
                                </FlexCenter>
