...
const SidebarProfile = ({ classname }) => {
    ...
    return (
        <FlexStart classname={`${classname} max-h-[418px] flex-col border border-gray-100 rounded-lg shadow-xs`} gap="gap-0">
            <TextCustom type="body_xl_500" classname="px-6 py-4">navigation</TextCustom>
