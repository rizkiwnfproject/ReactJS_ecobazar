            ...
            <FlexStart classname='flex-col w-full'>
                <FlexStart classname='flex-col'>
                    ...
                    <FlexStart classname='flex-col py-6' gap='gap-3'>
                        ...
                        <FlexStart classname='flex-col md:flex-row justify-center md:justify-between md:w-[215px] lg:w-[280px] xl:w-[400px]'>
                            <ImageCustom path="blog" image="image_5" classname="w-full object-cover" />
                            <ImageCustom path="blog" image="image_6" classname="w-full object-cover" />
                        </FlexStart>
                    ...
                    <FlexStart classname='flex-col' gap='gap-4'>
                        ...
                        <FlexStart classname='flex-col md:flex-row pt-4'>
                            <InputFormFragment classname="text-xs lg:text-sm xl:text-base" respText="text-sm" label="full name" type="text" name="full_name"  placeholder="John" />
                            <InputFormFragment classname="text-xs lg:text-sm xl:text-base" respText="text-sm" label="email" type="email" name="email" placeholder="example@gmail.com" />
                        </FlexStart>
                        <InputFormFragment classname="text-xs lg:text-sm xl:text-base" respText="text-sm" label="message" type="textarea" name="message" placeholder="write your message" />
                        <InputCustom
