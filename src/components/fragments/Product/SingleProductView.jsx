...
const SingleProductView = () => {
    ...
    return (
        <>
            <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-8 gap-5 p-6 items-center">
                <div className="col-span-1 flex lg:flex-col justify-center gap-3 items-center lg:mx-auto z-10 h-auto lg:w-auto lg:max-h-[400px] order-2 lg:order-1 ">
                ...
                <div className="order-1 lg:order-2 lg:col-span-3">
                    <ImageCustom path="products" image={activeImage} classname="w-[400px] h-[300px] lg:w-[320px] lg:h-[320px] xl:w-[450px] xl:h-[450px] mx-auto lg:mx-0 lg:max-w-2xl  object-cover" />
                </div>
                <FlexStart classname="order-3 flex-col lg:col-span-4">
                    ...
                    <FlexCenter classname="flex-col pt-3 pb-7 border-b border-b-gray-50" gap="gap-4">
                        <FlexStart classname="flex-col md:flex-row lg:flex-col xl:flex-row w-full justify-between">
                            <FlexCenter >
                                <TextCustom type="body_sm_400" respText="text-sm">Brand:</TextCustom>
                                <ImageCustom path="brand" image="image_1" />
                            </FlexCenter>
                            <FlexCenter>
                                <TextCustom type="body_sm_400" respText="text-sm">Share item:</TextCustom>
                                <FlexCenter>
                                    <Button
                                        typeButton="icon"
                                        hover={true}
                        ...
                        <TextCustom type="body_sm_400" respText="text-sm" textColor="text-gray-500" classname="text-justify">Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nibh diam, blandit vel consequat nec, ultrices et ipsum. Nulla varius magna a consequat pulvinar. </TextCustom>
                    </FlexCenter>
                    ...
                    <FlexStart classname="flex-col pt-4">
                        <TextCustom type="body_sm_500" respText="text-sm" classname="flex items-center">Category: &nbsp;<span className="text-sm font-normal text-gray-500">Vegetables</span></TextCustom>
                        <TextCustom type="body_sm_500" respText="text-sm" classname="flex items-center">Tag: &nbsp;<span className="text-sm font-normal text-gray-500">Vegetables
                            Healthy
                            Chinese
                            Cabbage
