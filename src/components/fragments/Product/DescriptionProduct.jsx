...
const DescriptionProduct = () => {
    return (
        <>
            <div className="grid grid-cols-1 lg:grid-cols-10 xl:grid-cols-8 mx-auto">
                <FlexStart classname="flex-col md:col-span-5 xl:col-span-4 text-justify" gap="gap-4">
                    <TextCustom type="body_sm_400" respText="text-sm" textColor="text-gray-500">
                    ...
                    <FlexStart classname="flex-col">
                        <TextCustom type="body_sm_400" respText="text-sm" textColor="text-gray-500" classname="flex items-center gap-2">
