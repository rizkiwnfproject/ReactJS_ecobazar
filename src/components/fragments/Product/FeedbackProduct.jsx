        ...
        <>
            <div className="mx-auto">
                <FlexStart classname="flex-col md:max-w-[760px]" gap="gap-4">
                        ...
                        <FlexCenter classname="justify-between">
                            <FlexCenter>
                                ...
                                <FlexStart classname="flex-col" gap="gap-0.5">
                                    <TextCustom type="body_sm_500" respText="text-sm">Kristin Watson</TextCustom>
                                    <Rating rate={5} />
                                </FlexStart>
                            </FlexCenter>
                            <TextCustom type="body_sm_400" respText="text-xs" textColor="text-gray-400">2 min ago</TextCustom>
                        </FlexCenter>
                        <TextCustom type="body_sm_400" respText="text-[13px]" textColor="text-gray-500">
                    ...
                    <FlexStart classname="flex-col py-4" gap="gap-3">
                        <FlexCenter classname="justify-between">
                            <FlexCenter>
                                <ImageCustom path="users" image="image_1" classname="w-10 h-10" />
                                <FlexStart classname="flex-col" gap="gap-0.5">
                                    <TextCustom type="body_sm_500" respText="text-sm">Ralph Edwards</TextCustom>
                                    <Rating rate={5} />
                                </FlexStart>
                            </FlexCenter>
                            <TextCustom type="body_sm_400" respText="text-xs" textColor="text-gray-400">2 min ago</TextCustom>
                    ...
                    <Button typeButton="buttonBasic" bgColor="bg-white" classname="md:w-1/4 lg:w-1/5 border-2 border-green-success" shadow="" textType="body_sm_600" textColor="text-green-success" respText="text-sm" label="Load More"  hover={false}/>
                </FlexStart>
            </div>
        </>
    )
