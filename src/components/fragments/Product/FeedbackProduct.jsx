    ...
    return (
        <>
            <div className=" max-w-10/12 mx-auto">
                <FlexStart classname="flex-col max-w-[760px]" gap="gap-4">
                    <FlexStart classname="flex-col border-b border-b-gray-100 py-4" gap="gap-3">
                        <FlexCenter classname="justify-between">
                            ...
                            <TextCustom type="body_sm_400" textColor="text-gray-400">2 min ago</TextCustom>
                        </FlexCenter>
                    ...
                    <FlexStart classname="flex-col border-b border-b-gray-100 py-4" gap="gap-3">
                        <FlexCenter classname="justify-between">
                            ...
                            <TextCustom type="body_sm_400" textColor="text-gray-400">30 Apr, 2021</TextCustom>
                        </FlexCenter>
                        <TextCustom type="body_sm_400" textColor="text-gray-500">
                    ...
                    <FlexStart classname="flex-col border-b border-b-gray-100 py-4" gap="gap-3">
                        <FlexCenter classname="justify-between">
                            <FlexCenter>
                                <ImageCustom path="users" image="image_1" classname="w-10 h-10" />
                                <FlexStart classname="flex-col" gap="gap-0.5">
                                    <TextCustom type="body_sm_500">Jacob Jones</TextCustom>
                                    <Rating rate={5} />
                                </FlexStart>
                            </FlexCenter>
                            <TextCustom type="body_sm_400" textColor="text-gray-400">2 min ago</TextCustom>
                    ...
                    <Button typeButton="buttonBasic" bgColor="bg-white" classname="w-1/5 border-2 border-green-success" shadow="" textType="body_sm_600" textColor="text-green-success" label="Load More"  hover={false}/>
                </FlexStart>
            </div>
        </>
    )
