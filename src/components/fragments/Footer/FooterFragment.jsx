    ...
    return (
        <>
            <Grid cols="grid-cols-5" >
                ...
                <div className="col-span-2 w-[535px] h-13 relative">
                    <InputCustom classname="px-6 py-3" rounded="rounded-full" type="text" placeholder="Your email address" name="subscribe" />
                    <Button typeButton="input" padding="px-10" height="h-13.5" textType="body_sm_600" textColor="text-white">subscribe</Button>
                </div>
            </Grid>
        </>
    )
