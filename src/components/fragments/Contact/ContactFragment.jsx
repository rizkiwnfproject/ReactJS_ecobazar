            ...
            <div className="flex flex-col md:grid md:grid-cols-4 gap-3" >
                <Card type="flexCenter" shadow="shadow-md" classname="flex-col" padding=''>
                    <FlexCenter width='md:max-w-[270px] w-full' justify='justify-center' classname="flex-col p-6 mx-auto text-center" gap='gap-4'>
                        ...
                        <TextCustom type="body_md_400" respText='text-xs' textColor='text-gray-800' classname='flex flex-col'>2715 Ash Dr. San Jose,
                    ...
                    <FlexCenter classname="w-full flex-col justify-center p-6 md:max-w-[270px] mx-auto text-center border-y border-gray-100" gap='gap-4'>
                        ...
                        <TextCustom type="body_md_400" respText='text-xs' textColor='text-gray-800' classname="flex flex-col">Proxy@gmail.com <span>Help@gmail.com</span> </TextCustom>
                    </FlexCenter>
                    <FlexCenter classname="w-full flex-col justify-center p-6 md:max-w-[270px] mx-auto text-center" gap='gap-4'>
                        ...
                        <TextCustom type="body_md_400" respText='text-xs' textColor='text-gray-800' classname="flex flex-col">(219) 555-0114 <span>(164) 333-0487</span></TextCustom>
                    </FlexCenter>
                </Card>
                        ...
                        <FlexStart classname='flex-col w-full'>
                            ...
                            <FlexStart classname='flex-col w-full py-5'>
                                <FlexStart classname='flex-col md:flex-row'>
                                    <InputCustom name="name" type="text" classname='text-sm lg:text-base' placeholder="Input Your Name" />
                                    <InputCustom name="email" type="email" classname='text-sm lg:text-base' placeholder="zakirsoft@gmail.com" />
                                </FlexStart>
                                <InputCustom name="title" type="text" classname='text-sm lg:text-base' placeholder="Input Your Title/Subject" />
                                <InputCustom name="subject_field" classname='text-sm lg:text-base' type="textarea" placeholder="Input Your Field of Subject" />
                            </FlexStart>
                            <Button typeButton="buttonBasic" classname="md:w-1/2 lg:w-1/3 xl:w-1/4" padding='py-6' textType='body_md_600' textColor='text-white' label='Send Message' />
                        </FlexStart>
                    </Card>
                </div>
            </div>
