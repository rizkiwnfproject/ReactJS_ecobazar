    ...
    return (
        <>
            <div className="grid grid-cols-4 gap-3" >
                <Card type="center_basic" shadow="shadow-md" classname="flex-col" padding=''>
                ...
                <div className="col-span-3">
                    <Card type="center_basic" padding="px-10 py-12" classname="w-full h-full" shadow="shadow-md">
                        <FlexStart classname='flex-col w-full'>
                            ...
                            <Button type="" classname="w-1/4">
                                <TextCustom type="body_md_600" textColor='text-white'>
                                    Send Message
                                </TextCustom>
                                </Button> 
                        </FlexStart>
